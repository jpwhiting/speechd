                         ...
                         char **error_result)
{
        ...
        connection->callback_audio = NULL;
                     ...
                     const char *state)
{
        ...
        NOTIFICATION_SET(SPD_AUDIO, "audio");
...
static void *spd_events_handler(void *conn)
{
        ...
        while (1) {
                ...
                if ((reply_code >= 700) && (reply_code < 800)) {
                        ...
                        if ((reply_code == 706) && connection->callback_audio) {
                                /* Client has registered to receive audio data, so send it to them */
                        }
                        free(reply);
