...
typedef void (*SPDCallbackAudio) (size_t msg_id, size_t client_id,
                                 SPDNotificationType state, const AudioTrack *track, AudioFormat format);
...
typedef struct {
        ...
        SPDCallbackAudio callback_audio;
